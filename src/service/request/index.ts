...
class TCRequest {
  ...
  request<T = any>(config: TCRequestConfig<T>): Promise<T> {
  ...
  get<T = any>(config: TCRequestConfig<T>): Promise<T> {
    return this.request<T>({ ...config, method: 'GET' })
  }

  post<T = any>(config: TCRequestConfig<T>): Promise<T> {
    return this.request<T>({ ...config, method: 'POST' })
  }

  delete<T = any>(config: TCRequestConfig<T>): Promise<T> {
    return this.request<T>({ ...config, method: 'DELETE' })
  }

  patch<T = any>(config: TCRequestConfig<T>): Promise<T> {
