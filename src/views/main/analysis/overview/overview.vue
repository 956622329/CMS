<template>
  <div class="overview">
    ...
    <tc-card title="技术栈">
      <tc-text-link :text-arrs="technologyStacks" />
      <tc-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <tc-card title="项目结构">
      <div class="c-left">
        <tc-code language="bash" :code="projectDir" />
      </div>
    </tc-card>
    <tc-card title="项目规范">
      <tc-descriptions
...
import TcDescriptions from '@/base-ui/descriptions'
import TcTextLink from '@/base-ui/text-link'
import TcCode from '@/base-ui/code'
import {
  technologyStacks,
  projectDir,
  dependencies,
